                        ...
                        <Card key={destination.id} className="group hover:shadow-xl transition-all duration-300 border-0 shadow-md overflow-hidden">
                            <div className="relative h-64 overflow-hidden">
                                ...
                                <Button
                                    ...
                                    className={`absolute top-4 right-4 rounded-full w-8 h-8 transition-all duration-200 ${favorites.has(destination.id)
                                ...
                                >
                                    <Heart
                                        className={`h-4 w-4 transition-all duration-200 ${favorites.has(destination.id) ? 'fill-current' : ''
                                            }`}
                                    />
                                </Button>
