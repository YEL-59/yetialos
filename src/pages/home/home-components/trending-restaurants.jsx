      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <Button
            variant="outline"
            size="icon"
            className="absolute left-2 sm:left-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg hover:shadow-xl transition-shadow rounded-full w-10 h-10 sm:w-12 sm:h-12"
            onClick={prevSlide}
          ...
          <Button
            variant="outline"
            size="icon"
            className="absolute right-2 sm:right-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg hover:shadow-xl transition-shadow rounded-full w-10 h-10 sm:w-12 sm:h-12"
            onClick={nextSlide}
          ...
          {/* Cards */}
          <div className="overflow-hidden mx-4 sm:mx-12">
            <div
                      ...
                      <CardContent className="p-4 sm:p-5">
                        <div className="space-y-3">
                          <div className="flex items-start justify-between">
                            <h3 className="font-semibold sm:font-bold text-base sm:text-lg text-gray-900 group-hover:text-teal-600 transition-colors">
                              {restaurant.name}
                            </h3>
                            <Badge
                              variant="outline"
