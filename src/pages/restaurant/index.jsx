...
import { MapPin, Star, Sparkles, Search, Mic } from "lucide-react";
...
const Restaurant = () => {
  ...
  const restaurants = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1604908176997-441b9d501c3f?w=800&h=600&fit=crop",
      priceRange: "$$",
    },
    {
      id: 6,
        ...
        <CardHeader className="pb-2">
          <div className="flex items-center justify-between">
            <CardTitle className="text-base">
              Ask AI for Restaurant Suggestions
            </CardTitle>
        ...
        <CardContent>
          <div className="flex items-center gap-2 bg-white rounded-full border border-teal-200 focus-within:border-teal-300 focus-within:ring-1 focus-within:ring-teal-300">
            ...
            <input
              ...
              placeholder="e.g. Best Italian restaurants for date night or family-friendly places with outdoor seating"
              className="flex-1 bg-transparent px-2 py-3 focus:outline-none placeholder-gray-500"
            />
            <Button
              variant="outline"
              size="icon"
              className="rounded-full bg-white border-teal-200 hover:bg-teal-50"
            >
              <Mic className="h-4 w-4" />
            </Button>
            <Button
              size="sm"
              className="bg-teal-600 hover:bg-teal-700 rounded-full mr-1"
              asChild
            >
              <Link to="/ai-assistant" state={{ query: aiQuery }}>
